...
import com.masai.sainath.mensxp.databinding.ActivityOpt2Binding;

import org.jetbrains.annotations.NotNull;

public class OptActivity1 extends AppCompatActivity {

    private ActivityOpt2Binding binding;
    private String verificationId;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityOpt2Binding.inflate(getLayoutInflater());
        ...
        binding.tvResendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(OptActivity1.this, "OTP Send Successfully.", Toast.LENGTH_SHORT).show();
            }
        });
...
//                binding.btnVerify.setVisibility(View.INVISIBLE);
                if (binding.etC1.getText().toString().trim().isEmpty() ||
                    ...
                    Toast.makeText(OptActivity1.this, "OTP is not Valid!", Toast.LENGTH_SHORT).show();
                } else {
...
//                                            binding.progressBarVerify.setVisibility(View.VISIBLE);
//                                            binding.btnVerify.setVisibility(View.INVISIBLE);
                                            Toast.makeText(OptActivity1.this, "Welcome...", Toast.LENGTH_SHORT).show();
                                            Intent intent = new Intent(OptActivity1.this, MainActivity.class);
